 ...
 */
final class Version20240408083508 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE item_grant ADD CONSTRAINT FK_E3A27D9CF7258000 FOREIGN KEY (штшinitiator_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
